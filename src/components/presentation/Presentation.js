      ...
      <div className='presentation__box'>
        ...
        <section className='coding__skills'>
          ...
          <p>
            ...
            that time being videogames, and now Software in general! I've seen
            all the crazy stuff people have made over the internet, and
            personally I want to join them. <br />
            So I started to learn by myself almost all the important languages
            for web development, and I'm always eager to learn something new.
            <br />
